...
public class EducacionServiceImpl implements EducacionService {
    ...
    @Override
    public void editEducacion(Educacion e, int id) {
        if (this.educacion.existsById(id)) this.educacion.save(e);
    }

    @Override
    public void deleteEducacion(int id) {
        if (this.educacion.existsById(id)) this.educacion.deleteById(id);
    }
