...
public class ProyectoServiceImpl implements ProyectoService {
    ...
    @Override
    public void editProyecto(Proyecto p, int id) {
        if (this.proyectos.existsById(id)) this.proyectos.save(p);
    }

    @Override
    public void deleteProyecto(int id) {
        if (this.proyectos.existsById(id)) this.proyectos.deleteById(id);
    }
