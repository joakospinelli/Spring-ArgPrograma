...
public class HabilidadesServiceImpl implements HabilidadesService {
    ...
    public void deleteHabilidad(int id) {
        if (this.habilidades.existsById(id)) this.habilidades.deleteById(id);
        
    }

    @Override
    public void editHabilidad(Habilidad h, int id) {
        if (this.habilidades.existsById(id)) this.habilidades.save(h);
    }
