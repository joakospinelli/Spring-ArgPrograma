...
public class ExperienciaServiceImpl implements ExperienciaService {
    ...
    public void deleteTrabajo(int id) {
        if (this.trabajos.existsById(id)) this.trabajos.deleteById(id);
    }

    @Override
    public void editTrabajo(Experiencia e, int id) {
        if (this.trabajos.existsById(id)) this.trabajos.save(e);
    }
